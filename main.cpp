...
int main(int argc, char *argv[]) {
    ...
    cout << "Пол: " << Human_Gender_Name[_gender] << endl;
    cout << "Возрастная группа: " << _name << endl;
    cout << "Индекс массы тела: " << setprecision(4) << _imt << endl;
    cout << _interprit;
    if (_interprit != Human_Results_Name[normal]) cout << setprecision(4) << _delta << " кг";
    cout << endl;
    RESET
