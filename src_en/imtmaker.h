...
public:
    std::unique_ptr<read_param> u_read_param;
    std::unique_ptr<x_param<int>> ages;
    std::unique_ptr<x_param<float>> wei_hei;
    std::unique_ptr<x_names> names;
    std::unique_ptr<delta_mass> d_mass;
    std::unique_ptr<explain_bmi> explain;
